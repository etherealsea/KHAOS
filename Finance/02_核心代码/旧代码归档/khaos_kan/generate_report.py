...
if __name__ == "__main__":
    model_path = r'd:\Finance\Finance\models\khaos_kan_model_final.pth'
    ...
    if os.path.exists(model_path):
        ...
        model_path = r'd:\Finance\Finance\models\khaos_kan_best.pth'
        if os.path.exists(model_path):
    ...
    data_dir = r'd:\Finance\Finance\data\model_research\data_processed'
    output_file = r'd:\Finance\Finance\docs\reports\KHAOS_KAN_Training_Report.md'
